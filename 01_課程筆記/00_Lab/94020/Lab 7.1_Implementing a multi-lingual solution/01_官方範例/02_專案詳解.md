...
4. 其中包含一個文檔及一個資料夾；`es.test.txt` 就是翻譯為西班牙文的 `目標文件`。

    ![](images/img_47.png)

<br>

5. 另外，執行翻譯工作時會自動生成一個 `details` 資料夾，點擊進入可看到一個文件 `es.auxiliary-translation-details.json`，其中包含與翻譯工作相關的詳細資料。

    ![](images/img_56.png)

<br>

6. 可在本地進行查看，內容有翻譯工作的狀態、錯誤報告、作業的輸入和輸出文件摘要等。
...
7. Amazon Translate 輸出結果檔案 `.txt`，可下載查看。
...
_原本誤解了西班牙文的符號是亂碼所以進行以下的處理，後來確認這是標準表示並非亂碼，不過還是保留這段說明，僅供參考可以略過。_
...
5. 點擊播放。
    ...
    [點擊這裡播放音頻]("https://github.com/samhsiao6238/AWS_2024/blob/main/01_課程筆記/00_Lab/94020/Lab 7.1_Implementing a multi-lingual solution/01_官方範例/audio/audio1.mp3")

    [點擊這裡播放音頻](https://github.com/samhsiao6238/AWS_2024/blob/main/01_%E8%AA%B2%E7%A8%8B%E7%AD%86%E8%A8%98/00_Lab/94020/Lab%207.1_Implementing%20a%20multi-lingual%20solution/01_%E5%AE%98%E6%96%B9%E7%AF%84%E4%BE%8B/audio/audio1.mp3)
